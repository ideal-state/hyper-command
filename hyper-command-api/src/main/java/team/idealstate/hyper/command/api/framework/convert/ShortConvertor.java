 ...
 * <p>ShortConvertor</p>
 *
 * <p>创建于 2024/3/1 11:43</p>
 *
 * @author ketikai
 * @version 1.0.0
 * @since 1.0.0
 */
public final class ShortConvertor implements ArgumentConvertor<Short> {
    @Override
    public @NotNull Short convert(@NotNull CommandContext context, @NotNull String argument) {
