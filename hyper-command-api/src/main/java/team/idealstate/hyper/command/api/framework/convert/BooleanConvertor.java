...
/**
 * <p>BooleanConvertor</p>
 *
 * <p>创建于 2024/2/29 22:17</p>
 *
 * @author ketikai
 * @version 1.0.0
 * @since 1.0.0
 */
public final class BooleanConvertor implements ArgumentConvertor<Boolean> {
    @Override
    public @NotNull Boolean convert(@NotNull CommandContext context, @NotNull String argument) {
