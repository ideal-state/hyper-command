 ...
 * <p>StringConvertor</p>
 *
 * <p>创建于 2024/2/29 21:52</p>
 *
 * @author ketikai
 * @version 1.0.0
 * @since 1.0.0
 */
public final class StringConvertor implements ArgumentConvertor<String> {
    @Override
    public @NotNull String convert(@NotNull CommandContext context, @NotNull String argument) {
