 ...
 * @since 1.0.0
 */
public final class DoubleConvertor implements ArgumentConvertor<Double> {
    @Override
    public @NotNull Double convert(@NotNull CommandContext context, @NotNull String argument) throws Throwable {
