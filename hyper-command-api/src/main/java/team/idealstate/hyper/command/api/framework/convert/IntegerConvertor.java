...
/**
 * <p>IntegerConvertor</p>
 *
 * <p>创建于 2024/3/1 11:41</p>
 *
 * @author ketikai
 * @version 1.0.0
 * @since 1.0.0
 */
public final class IntegerConvertor implements ArgumentConvertor<Integer> {
    @Override
    public @NotNull Integer convert(@NotNull CommandContext context, @NotNull String argument) {
