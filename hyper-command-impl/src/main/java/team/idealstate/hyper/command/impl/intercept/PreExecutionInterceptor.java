...
/**
 * <p>PreExecutionInterceptor</p>
 *
 * <p>创建于 2024/2/16 19:28</p>
 *
 * @author ketikai
 * @version 1.0.0
 * @since 1.0.0
 */
public abstract class PreExecutionInterceptor implements ActionInterceptor {

    @Override
    public boolean intercept(@NotNull CommandContext context, @NotNull CommandAction action) {
        if (CommandAction.EXECUTE.equals(action)) {
