...
/**
 * <p>ThreadLocalCommandContextFactory</p>
 *
 * <p>创建于 2024/2/16 19:01</p>
 *
 * @author ketikai
 * @version 1.0.0
 * @since 1.0.0
...
public final class ThreadLocalCommandContextFactory implements CommandContextFactory {
    ...
    private static final ThreadLocal<CommandContext> CURRENT_COMMAND_CONTEXT =
            ThreadLocal.withInitial(CommandContextImpl::new);
